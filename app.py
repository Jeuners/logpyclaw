...
SKILLS = [
    ...
    },
    {
        ...
        "name": "Telegram",
        "icon": "✈️",
        "description": "Sendet Bilder oder Text an Telegram (Trigger: 'schick das Bild nach Telegram')",
        "requires": None,
    },
    {
        "id": "image_edit",
        ...
        "icon": "✏️",
        "description": "Bearbeitet hochgeladene Bilder via FireRed Image Edit (ComfyUI)",
        "requires": "comfyui",
    },
]
